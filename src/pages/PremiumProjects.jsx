...
import "../css_files/premium_projects.css";
    ...
    <div className="no-premium-container">
      ...
      <div className="premium-content">
        ...
        <h1 className="premium-title">
          No <span className="gradient-text">Premium Projects</span> for You
        </h1>
        ...
        <div className="premium-features">
          <div className="feature-item">
            ...
            <span className="feature-text">Exclusive Premium Projects</span>
          </div>
          <div className="feature-item">
            <div className="feature-icon-wrapper">
              <Sparkles className="feature-icon" />
            </div>
            <span className="feature-text">Industry Given Projects</span>
          </div>
          <div className="feature-item">
            <div className="feature-icon-wrapper">
