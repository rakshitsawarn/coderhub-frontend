...
function CPP() {
  ...
  const getLink = (name) => {
    switch (name) {
      case "Basics":
        return "/CPP/basics_cpp";
      case "Intermediate":
        return "/CPP/intermediate_cpp";
      case "Advanced":
        return "/CPP/advance_cpp";
      case "Practice Questions":
        return "/CPP/practice_cpp";
      case "Projects":
        return "/CPP/projects_cpp";
      case "Learning Roadmap":
        return "/CPP/learning_roadmap_cpp";
      case "Interview Questions":
        return "/CPP/interview_questions_cpp";
      default:
        return "#";
    }
  };
  ...
  const cards = [
    {
      title: "Basics",
      description: "Master Basics of C++ programming",
      icon: "🔰",
      color: "#667eea",
      topics: ["Classes", "Loops", "Functions", "Arrays"]
    },
    {
      title: "Intermediate",
      description: "Master intermediate concepts of C++",
      icon: "⚙️",
      color: "#764ba2",
      topics: ["Inheritance", "Polymorphism", "Templates", "STL"]
    },
    {
      title: "Advanced",
      description: "Master advanced C++ programming concepts",
      icon: "🚀",
      color: "#f093fb",
      topics: ["Multithreading", "Design Patterns", "Memory Management", "GED"]
    },
    {
    ...
    },
    {
      ...
      icon: "🧩",
      color: "#43e97b",
      topics: ["Banking System", "Library Management", "2D Game Engine"]
    },
    {
