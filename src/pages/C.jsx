...
function C() {
  ...
  const getLink = (name) => {
    switch (name) {
      ...
      case "Interview Questions":
        return "/C/interview-questions_c";
      default:
        return "#";
    }
  };
  ...
  const cards = [
    ...
    },
    {
      ...
      icon: "⚙️",
      color: "#764ba2",
      topics: ["Structures", "File I/O", "Memory Allocation", "Recursion"]
    },
    {
      title: "Advanced",
      ...
      icon: "🚀",
      color: "#f093fb",
      topics: ["Data Structures", "System Calls", "Embedded Programming", "Optimization"]
    },
    {
    ...
    },
    {
      ...
      icon: "🧩",
      color: "#43e97b",
      topics: ["Calculator", "Student Record System", "Games", "Shell"]
    },
    {
