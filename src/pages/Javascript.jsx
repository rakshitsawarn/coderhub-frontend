...
import "/src/css_files/Javascript.css";
...
function JavaScript() {
  ...
  const getLink = (name) => {
    switch (name) {
      case "Basics":
        return "/JavaScript/basics_js";
      case "Intermediate":
        return "/JavaScript/intermediate_js";
      case "Advanced":
        return "/JavaScript/advance_js";
      case "Practice Questions":
        return "/JavaScript/practice_js";
      case "Projects":
        return "/JavaScript/projects_js";
      case "Learning Roadmap":
        return "/JavaScript/learningroadmap_js";
      case "Interview Questions":
        return "/JavaScript/interviewQ_js";
      default:
        return "#";
    }
  };
    ...
    <div className="c-page-container">
      ...
      <div className="c-hero">
        <div className="c-hero-badge">
          <span className="badge-icon">JavaScript</span>
      ...
      <div className="c-cta-section">
        <h2>Ready to Master JavaScript Programming?</h2>
